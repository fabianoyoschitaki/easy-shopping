...
import com.fornax.bought.fragment.NavigationDrawerFragment;
...
public class InitialActivity extends Activity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.title_cartoes);
                break;
            case 2:
                mTitle = getString(R.string.title_configuracoes);
                break;
            case 3:
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((InitialActivity) activity).onSectionAttached(
